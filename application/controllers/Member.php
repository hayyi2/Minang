...
class Member extends CI_Controller {
	...
	public function view()
	{
		$params = array(
			'title' 		=> 'Data Member',
			'acive_menu' 	=> 'member',
			'data' 			=> $this->user_model->gets(array('where' => array('capability' => 1))),
		);

		$this->load->view('header', $params);
		$this->load->view('member-list', $params);
	...
	public function input()
	{
		...
		$this->load->view('header', $params);
		$this->load->view('member-input', $params);
		$this->load->view('footer', $params);
	}
